...
const GroupGallary = () => {
  return (
    <div className="container mx-auto">
        ...
        <h1 className="font-bold text-3xl" > College Graduate's Group Gallary</h1>
        </div>
      <div class="grid grid-cols-2 md:grid-cols-3 gap-4 px-20 mt-10 justify-center items-center">
        <div>
          <img
