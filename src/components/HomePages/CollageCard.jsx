...
import "../HomePages/CollageCard.css";
...
const CollageCard = () => {
  ...
  return (
    <div className="container mx-auto">
      ...
      {visibleCards < allCollageData.length && (
