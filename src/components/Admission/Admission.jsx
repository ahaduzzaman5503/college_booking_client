...
const handleAddToy = (event) => {
    ...
    const admission = {
      sname, subject, email, number, address, dob, photoUrl,
    };
...
const Admission = () => {
  return (
    ...
    <div className="container mx-auto flex justify-center my-5 ">
      <div class="w-3/4 text-sm font-medium text-gray-900 bg-white border rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white shadow-2xl my-6 border-gray-50 border-3">
