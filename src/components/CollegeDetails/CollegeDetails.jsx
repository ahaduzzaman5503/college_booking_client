      ...
      <div className=" flex justify-center items-center">
          <div className="w-3/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div className="p-5">
              ...
              <p className='flex justify-center font-bold text-xl underline'> Admission Process</p>
              ...
              <div className="divider"></div> 
                <p className='flex justify-center font-bold text-xl underline'> Events Details</p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                {" "}
              ...
              <div className="divider"></div> 
                 <p className='flex justify-center font-bold text-xl underline'> Research Works</p>
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                {" "}
              ...
              <div className="divider"></div>
                               ...
                               <p className='flex justify-center font-bold text-xl underline'> Sports Categories</p>
              ...
              <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
                ...
                <li>
                {singleCollage.sports_categories[0]}
                </li>
                <li>
                {singleCollage.sports_categories[1]}
                </li>
                <li>
                {singleCollage.sports_categories[2]}
                </li>
              </p>

              <div className="divider"></div> 

              <p className='flex justify-center font-bold text-xl underline'> Research History</p>
              ...
              <button  className='btn btn-success' ><Link to="/">Back to home</Link></button> OR <button className='btn btn-success' ><Link to="/colleges">Back to All Collages</Link></button>
                </div>
            </div>
          </div>
      </div>
